...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260423084938_task10-PayOS3")]
    partial class task10PayOS3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<Guid?>("linkedShipmentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("selectedShipmentJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Payment", b =>
                {
                    b.HasOne("Domain.Entities.Order", "linkedOrder")
                        .WithMany()
                        .HasForeignKey("linkedOrderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Entities.Shipment", "linkedShipment")
                        .WithMany()
